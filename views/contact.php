	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-lg-3 mb-5">
				<h3>Our offices</h3>
				<p>With offices throughout the world, you can connect with one near to you.</p>
			</div>
			<!--Address -->
			<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
				...
				<a href="#" class="btn btn-sm btn-light">View location <i class="far fa-map ms-3"></i></a>
			</div>
			<!--Address -->
			<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
		...
		<div class="row">
			<div class="col-12">
				<div class="d-flex justify-content-between align-items-center">
					<div>
						<h2 class="text-white-stroke display-5">Join the team</h2>
						<p class="lead text-white pe-0 pe-lg-6">We are hiring! Join our team Creative Agency Specializing in: Video Production, Web Design, Branding, Brand Strategy.</p>
					</div>
					<div>
						<a href="#" class="btn btn-dark btn-line btn-lg">Apply now!</a>
					</div>
				</div>
			</div>
		</div> <!-- Row END -->
