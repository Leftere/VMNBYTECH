		...
		<section class="bg-parallax bg-dark-overlay-4 py-5 py-md-8"
			...
			<div class="container">
				<div class="row d-flex justify-content-lg-between">
					<!-- Inner intro title -->
					<div class="col-lg-10">
						<h1 class="display-5 text-white">Let's do <span class="text-white-stroke text-primary-shadow">
								Awesome things</span></h1>
		...
		<div class="row">
			<div class="col-12">
				<div class="d-flex justify-content-between align-items-center">
					<div>
						<h2 class="text-white-stroke display-5">Explore our services</h2>
						<p class="lead text-white pe-0 pe-lg-6">Discover a world of possibilities with our tailored solutions to meet your every need.</p>
					</div>
					<div>
						<a href="/services#our-services" class="btn btn-dark btn-line btn-lg">Services</a>
					</div>
				</div>
			</div>
		</div> <!-- Row END -->
