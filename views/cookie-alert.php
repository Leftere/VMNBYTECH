<div id="cookieConsentPopup" style="display:none"
    class=" cookie-box alert alert-dismissible fade show bg-dark text-white position-fixed start-0 bottom-0 z-index-9 shadow rounded-0 p-4 ms-3 mb-3 col-9 col-md-3"
    role="alert">
    ...
    <a class="text-primary" href="/terms-and-conditions "> Privacy Policy</a>
    <div class="mt-4">
    ...
    <div class="position-absolute end-0 top-0 mt-n4 me-n4"><img class="w-100" src="assets/images/cookie.svg"
            alt="cookie"></div>
</div>