                        ...
                        <div class="row d-flex h-100">
                            <div class="col-md-8 justify-content-center align-self-center align-items-start">
                                <div class="slider-content text-start">
                                    <h5 class="animate__animated animate__fadeInUp animate__delay-1s text-white mt-5 my-md-4">
                                        Engineering Digital Transformation, One Pixel at a Time
                                    </h5>
                                    <h2 class="animate__animated animate__fadeInUp animate__delay-2s display-4 fw-bold text-white">
                                        <span class="text-white-stroke text-primary-shadow d-block">
                                            Creating Real
                                        </span>
                                        Business Value
                                    </h2>
                                    <p class="animate__animated animate__fadeInUp animate__delay-3s lead text-white d-none d-sm-block">
            ...
            <div class="row">
                <div class="col-lg-8 mb-5">
                    ...
                    <p>
                        ...
                        A Full Service Digital Creative Agency Specializing in: Video
